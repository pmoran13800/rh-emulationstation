...
void ViewController::goToStart()
{
	...
	if (RHGamestationConf::getInstance()->get("emulationstation.hidesystemview") == "1" || RHGamestationConf::getInstance()->get("emulationstation.bootongamelist") == "1")
...
std::shared_ptr<IGameListView> ViewController::getGameListView(SystemData* system)
{
	...
	if(detailed && ! (RHGamestationConf::getInstance()->get("emulationstation.forcebasicgamelistview") == "1"))
...
bool ViewController::input(InputConfig* config, Input input)
{
	...
	// open menu
	if(config->isMappedTo("start", input) && input.value != 0 && RHGamestationConf::getInstance()->get("emulationstation.menu") != "none" )
	{
		// open menu
...
std::vector<HelpPrompt> ViewController::getHelpPrompts()
{
	...
	if(RHGamestationConf::getInstance()->get("emulationstation.menu") != "none"){
...
int ViewController::getFirstSystemIndex() {
	std::string systemName = RHGamestationConf::getInstance()->get("emulationstation.selectedsystem");
	if(systemName != ""){
