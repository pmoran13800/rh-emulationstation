#ifndef RHGAMESTATION_SYSTEM
#define    RHGAMESTATION_SYSTEM
...
class RHGamestationSystem {
public:

    static RHGamestationSystem *getInstance();
...
private:
    static RHGamestationSystem *instance;
