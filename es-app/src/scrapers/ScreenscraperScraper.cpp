...
{
	std::string path = "https://screenscraper.rhgamestation.com/api/thegamedb/GetGame.php?";
	std::string languageSystem = RHGamestationConf::getInstance()->get("system.language");
