...
std::vector<const char *> settings_dont_save = boost::assign::list_of
        ...
        ("VersionFile")
        ("SharePartition")
        ("RHGamestationSettingScript")
        ("RHGamestationConfigScript")
        ("LastVersionFile")
        ("VersionMessage")
        ("MusicDirectory")
		("ThemeChanged")
...
void Settings::setDefaults() {
    ...
    mStringMap["UpdateCommand"] = "/rhgamestation/scripts/rhgamestation-upgrade.sh";
    mStringMap["UpdateServer"] = "archive.rhgamestation.com";
    mStringMap["VersionFile"] = "/rhgamestation/rhgamestation.version";
    mStringMap["UpdateVersionFile"] = "/rhgamestation/share/system/upgrade/rhgamestation.version.update";
    mStringMap["SharePartition"] = "/rhgamestation/share/";
    mStringMap["RHGamestationSettingScript"] = "/rhgamestation/scripts/rhgamestation-config.sh";
    mStringMap["RHGamestationUpgradeScript"] = "/rhgamestation/scripts/upgrade/rhgamestation-upgrade.sh";
    mStringMap["LastChangelog"] = "/rhgamestation/share/system/rhgamestation.changelog.done";
    mStringMap["UpdateChangelog"] = "/rhgamestation/share/system/upgrade/rhgamestation.changelog.update";
    mStringMap["Changelog"] = "/rhgamestation/rhgamestation.changelog";
    mStringMap["MusicDirectory"] = "/rhgamestation/share/music/";
